...
[Recall from Hoon School](../../../../courses/hoon-school/E-types/) that `cord`s are atoms with the aura`@t` and are typically used to represent strings internally as data, as atoms\
